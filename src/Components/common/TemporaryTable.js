...
// Assuming these functions are not defined elsewhere

// Function to sort the data array in a stable manner
function stableSort(array, comparator) {
 ...
 // Function to get the comparator based on the order and orderBy props
 ...
 // Assuming EnhancedTableToolbar is not defined elsewhere
 function EnhancedTableToolbar(props) {
  // Implementation of the toolbar component
 }
...
export default function EnhancedTable({ headCells, rowsData }) {
...
// Exporting the EnhancedTable component
